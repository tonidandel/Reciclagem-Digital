...
% ---
\titulo{Modelo de Relatório Técnico com \abnTeX  \\ ajustado às normas da UFOP}
\autor{Equipe do Programa de Extensão Reciclagem Digital}
\local{Brasil}
\data{2016}
\instituicao{%
  Universidade Federal de Ouro Preto - UFOP
  \par
  Departamentos de Engenharia de Controle e Automação e Engenharia de Produção
  \par
